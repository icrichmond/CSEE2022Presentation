...
*Spatial Heterogeneity + Temporal Heterogeneity + Inequity + Urban Forest*
...
So essentially, the goal of this chapter is to attempt to fill in some of these gaps that we just talked about by doing science that addresses both spatial and temporal heterogeneity, while incorporating inequities and social science, into questions regarding our urban forest. So to do that...
...
.footnote[ .small[ [10]: [Qiu & Turner](https://www.pnas.org/doi/10.1073/pnas.1310539110)] ] 
...
.footnote[ .small[ [11]: [Gerrish & Watkins, 2018](https://linkinghub.elsevier.com/retrieve/pii/S0169204617302062)]]
...
.footnote[ .small[ [12]: [Watkins & Gerrish, 2018](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5889081/)
]]
...
.footnote[ .small[ [13]: [Adapted from Pham et al. 2017](http://dx.doi.org/10.1016/j.landurbplan.2016.09.001)
]]
...
1. Broad, landscape scale study on urban ecosystem services + generalizable knowledge on drivers 

--

2. Addition of temporal heterogeneity to the field + impacts of park development choices   

--

3. Process of gentrification in Montreal

--

4. Integration of natural and social sciences 
...
```{r, echo = F, fig.align='center', out.width='35%', out.height='35%'}
knitr::include_graphics("JD_1874.JPG")
```
...
knitr::include_graphics("JD_1930.JPG")
```
...
```{r, echo = F, fig.align='center', out.width = '75%'}
knitr::include_graphics("JD_1954.JPG")
```
