...
density  <- rnorm(n = N, mean = 0, sd = 1)
NAGen  <- (rho1 * x1) + sqrt(1 - rho1*rho1) * rnorm(n = N, mean = 0, sd = 1)
Gen <- (rho2 * x1) + sqrt(1 - rho2*rho2) * rnorm(n = N, mean = 0, sd = 1)
DNGen  <- (rho3 * x1) + sqrt(1 - rho3*rho3) * rnorm(n = N, mean = 0, sd = 1)
