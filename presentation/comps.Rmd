...
- Script 
- Break down Ch. 1 DAG 
- Add Paquette paper to back deck of slides 
- Add table of all variables + sources for ch 1 to back of slide deck 
...
1) Previous land-use type and will influence urban forest composition and ecosystem service capacity in today's parks 
  - Land use types that resulted in an *input* of nutrients, i.e., <span style="color:#556219; font-weight: 700">natural</span> and <span style = "color:#E5A335; font-weight: 700">agricultural</span>,  will have bigger trees and higher ecosystem service capacity 
  - Previous land use types that *contaminated* the soil, i.e., <span style = "color:#591D06; font-weight: 700">industrial</span>, will have smaller trees and lower ecosystem service capacity  
